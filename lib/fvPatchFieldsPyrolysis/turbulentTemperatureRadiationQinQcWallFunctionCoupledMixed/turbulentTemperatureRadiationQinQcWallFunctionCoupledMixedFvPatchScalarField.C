...
#include "turbulentTemperatureRadiationQinQcWallFunctionCoupledMixedFvPatchScalarField.H"
...
turbulentTemperatureRadiationQinQcWallFunctionCoupledMixedFvPatchScalarField
(
    const turbulentTemperatureRadiationQinQcWallFunctionCoupledMixedFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
tmp<scalarField>
turbulentTemperatureRadiationQinQcWallFunctionCoupledMixedFvPatchScalarField::K() const
{
...
void turbulentTemperatureRadiationQinQcWallFunctionCoupledMixedFvPatchScalarField::
updateCoeffs()
{
    if (updated())
    {
...
void turbulentTemperatureRadiationQinQcWallFunctionCoupledMixedFvPatchScalarField::write
(
    Ostream& os
) const
{
