...
eddyDissipationDiffusionModel<CombThermoType, ThermoType>::eddyDissipationDiffusionModel
(
...
eddyDissipationDiffusionModel<CombThermoType, ThermoType>::rtTurb() const
{
...
template<class CombThermoType, class ThermoType>
void eddyDissipationDiffusionModel<CombThermoType, ThermoType>::correct()
{
    this->wFuel_ ==
