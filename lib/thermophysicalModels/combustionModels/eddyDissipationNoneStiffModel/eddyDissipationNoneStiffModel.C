...
#include "eddyDissipationNoneStiffModel.H"
...
eddyDissipationNoneStiffModel<CombThermoType, ThermoType>::eddyDissipationNoneStiffModel
(
...
template<class CombThermoType, class ThermoType>
void eddyDissipationNoneStiffModel<CombThermoType, ThermoType>::correct()
{
    this->wFuel_ ==
...
template<class CombThermoType, class ThermoType>
bool eddyDissipationNoneStiffModel<CombThermoType, ThermoType>::read()
{
