...
#include "greyMeanAbsorptionEmissionSoot.H"
...
namespace Foam
{
    namespace radiation
    {
        defineTypeNameAndDebug(greyMeanAbsorptionEmissionSoot, 0);

        addToRunTimeSelectionTable
        (
            absorptionEmissionModel,
            greyMeanAbsorptionEmissionSoot,
            dictionary
        );
    }
}
...
Foam::radiation::greyMeanAbsorptionEmissionSoot::aCont(const label bandI) const
{
